...
<?php
    ...
    <?php
       $sql= mysqli_query($con,"select ca.*, cv.* from create_account ca, class_venue cv where ca.course2=cv.courses AND utmid='$utmid'");
    ...
    <td><h6><b><?php echo $result['course2']; ?></b></h6></td>
    <td>&nbsp;</td>
    <td>
    <h5><b>Course section: </b></h5>
    </td>
    <td><h5><?php echo $result['section2']; ?></h5></td>
    </tr>
    &nbsp;
    <tr>
    <td>
