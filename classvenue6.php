...
<?php
    ...
    <?php
       $sql= mysqli_query($con,"select ca.*, cv.* from create_account ca, class_venue cv where ca.course6=cv.courses AND utmid='$utmid'");
       $result=mysqli_fetch_array($sql);
    ?>

    <div class="container my-5 pt-3 pb-3 pl-5 z-depth-1 c">
    
    <table><tr>
    <td>
    <h5><b>Course name: </b></h5>
    </td>
    <td><h6><b><?php echo $result['course6']; ?></b></h6></td>
    <td>&nbsp;</td>
    <td>
    <h5><b>Course section: </b></h5>
    </td>
    <td><h5><?php echo $result['section6']; ?></h5></td>
    </tr>
    &nbsp;
    <tr>
    <td>
