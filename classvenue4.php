...
<?php
    ...
    <?php
       $sql= mysqli_query($con,"select ca.*, cv.* from create_account ca, class_venue cv where ca.course4=cv.courses AND utmid='$utmid'");
    ...
    <td><h6><b><?php echo $result['course4']; ?></b></h6></td>
    <td>&nbsp;</td>
    <td>
    <h5><b>Course section: </b></h5>
    </td>
    <td><h5><?php echo $result['section4']; ?></h5></td>
    </tr>
    &nbsp;
    <tr>
    <td>
