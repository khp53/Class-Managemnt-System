...
<body>
    ...
    ?>
    <?php
       $sql= mysqli_query($con,"select ca.*, li.* from create_account ca, lecturer_info li where ca.lecturer1=li.lecturer_name AND utmid='$utmid'");
    ...
    <div class="container my-5 pt-1 pb-1 z-depth-1 text-center">
        ...
        <br>
        <br>
        <h2><b>Name: </b><?php echo $result['lecturer1']; ?></h2>
